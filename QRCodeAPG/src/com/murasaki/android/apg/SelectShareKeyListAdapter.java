...
public class SelectShareKeyListAdapter extends BaseAdapter {
    ...
    public SelectShareKeyListAdapter(Activity activity, ListView parent, String searchString) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        View view = mInflater.inflate(R.layout.select_share_key_item, null);
        ...
        if (enabled) {
            status.setText(R.string.canShare);
        } else {
